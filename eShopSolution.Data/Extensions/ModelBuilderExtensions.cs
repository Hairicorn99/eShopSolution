    ...
    public static class ModelBuilderExtensions
    {
     ...
     new AppConfig() { Key = "HomeDescription", Value = "This is description of eShopSolution" }
           ...
           new Product()
           {
            ...
            // any guid
            var roleId = new Guid("66B6B862-D182-4BA0-98B2-34756DE6D57B");
            var adminId = new Guid("7C1EB3A0-E392-48AA-AD08-1F9B28E320D1");
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "duchai.international@gmail.com",
                NormalizedEmail = "duchai.international@gmail.com",
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null, "123654aA@"),
